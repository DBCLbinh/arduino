...
var SS = SpreadsheetApp.openById('1iqEJd-NqrJ2Zd6KWa7qBtDjbkSuY6pEBlYVK6Le6Kx');// thay Id nay thành Id trang tinh của bạn
  // nó là Id của trang tính bạn tạo ra https://docs.google.com/spreadsheets/d/1iqEJd-NqrJ2Zd6KWa7qBtDjbkSuY6pEBlYVK6Le6Kx/edit#gid=0
var str = "";
...
//var SS = SpreadsheetApp.openById('1I-oRgU0WjP9JSqIk3NwmRglQrz3UcQMLm3zyBQqX2yA');
...
function doGet(e){
  ...
  if (read !== undefined){
    return ContentService.createTextOutput(sheet2.getRange(read).getValue());
  }
